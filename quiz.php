<?php 
	...
	$ans_text_array = Array(
		...
		"ans4" => "Voice (\"Vox\") is both a Spanish political party created in December 2013 by former members of the People's Party, receiving 1.6% in the 2014 European Parliament Elections (<a href='http://en.wikipedia.org/wiki/Vox_%28Spanish_political_party%29'>http://en.wikipedia.org/wiki/Vox_%28Spanish_political_party%29</a>), and  the Swedish entry in the 2009 Eurovision Song Contest (La Voix), which despite (or because of) some lightbulb-blowing high notes, received only 33 votes and placed 21st out of 25 competitors (www.youtube.com/watch?v=5WH2OwJeMBE).",
		"ans5" => "\"Ordinary People\" (Obyčajní Ľudia) is a political party in Slovakia created in October 2011 by entrepreneur and maverick parliamentary deputy Igor Matovič which won 8.55% of the vote in Slovakia's March 2010 election, (<a href='http://en.wikipedia.org/wiki/Ordinary_People_%28Slovakia%29'>http://en.wikipedia.org/wiki/Ordinary_People_%28Slovakia%29</a>).  Matovič first gained prominence in the 2010 election when he and 3 close colleagues , made skillful use of local media and preference voting to propel themselves from the last 4 places on the list of the Freedom and Solidarity to the top of the list.  They had used the name Ordinary People to describe their grouping but did make the move to transform it into a party until shortly before the election.  On arriving at the Ministry of the Interior, they were informed that another dormant party had earlier that day changed /its/ name to Ordinary People and that the name was therefore taken, forcing Matovič to adopt the name \"Ordinary People and Independent Personages.\"",
		...
		"ans13" => "\"I Believe\" (Verjamem) is both a Slovenian political party founded by Igor Šoltes, a lawyer and former president of Slovenia's audit court--founded in the spring of 2014 it managed 10.5% in the May 2014 European Parliament elections--and Slovenia's entry in the 2012 Eurovision Song Contest sung by Eva Boto--gaining 31 points and a 17th place finish.  In the first weeks of the founding of the /party/, internet searches in both Slovene and English pointed almost exclusively to the /song/."		
		);
